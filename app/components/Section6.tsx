  ...
  return (
    <section className="w-full bg-white flex justify-center items-center py-16 md:py-24 lg:py-32">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:items-stretch gap-8 lg:gap-12">
          {/* Responsive Images: Small, Medium, Large */}
          <div className="w-full flex justify-center lg:justify-end mb-8 lg:mb-0">
            {/* Small screen image */}
            <div className="block sm:hidden w-full">
              <Image
                src="/section6-ImageSmall.png"
          ...
          <div className="w-full flex flex-col items-center lg:items-start justify-center text-center lg:text-left">
