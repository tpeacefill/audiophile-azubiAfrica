    ...
    <section className="w-full bg-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center gap-12 lg:flex-row-reverse lg:items-center lg:gap-20 px-0">
        ...
        <motion.div
          ...
          className="w-full flex justify-center lg:justify-end lg:px-8 lg:flex-1"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
          className="w-full max-w-2xl text-center flex flex-col lg:pl-8 items-center lg:items-start lg:text-left lg:flex-1"
        >
